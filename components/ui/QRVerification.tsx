...
// =====================================================================
// PARTICIPANT QR GENERATOR - QR per peserta untuk Status Peserta (Tarik Diri)
// =====================================================================
...
export const ParticipantQRGenerator: React.FC<ParticipantQRGeneratorProps> = ({ data, year = new Date().getFullYear(), className = '' }) => {
  const [isOpen, setIsOpen] = useState(false);
